        ...
        <div class="col-md-8 col-xs-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="#hojavida" data-toggle="tab">Hoja de vida</a></li>
                </ul>
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="hojavida">
                        <form action="#" method="POST" id="form-change-hoja" enctype="multipart/form-data">
                            <input type="hidden" name="idUsuario" value="<?php echo $usuario->id;?>">
                            <?php if ($usuario->hoja !=""): ?>
                                <div class="form-group text-center">
                                    <a href="<?php echo base_url();?>assets/pdf/usuarios/<?php echo $usuario->hoja;?>" class="btn btn-primary btn-flat" target="_blank">Visualizar hoja de vida</a>
                                </div>
                            <?php endif ?>
                            ...
                            <div class="form-group">
                                ...
                                <span class="help-block">Debe seleccionar un archivo .pdf</span>
