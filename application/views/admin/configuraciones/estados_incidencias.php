<section class="content-header">
    <h1>
        Estados de Incidencias <small> Listado</small>
    </h1>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if ($permisos->delete == 1): ?>
                                                    <a href="<?php echo base_url();?>configuraciones/estadosincidencias/delete/<?php echo $estado->id?>" class="btn btn-danger btn-flat btn-delete">
...
<div class="modal fade" id="modal-default">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?php echo base_url();?>configuraciones/estadosincidencias/save" method="POST" id="form-estado">
